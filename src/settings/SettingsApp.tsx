...
const TABS: { id: SettingsTab; label: string; icon: typeof Settings01Icon, component: () => JSX.Element }[] =
  [
    ...
    { id: "models", label: "智能终端", icon: AiScanIcon, component: ModelsSection },
    { id: "agent-config", label: "编码配置", icon: PenTool01Icon, component: AgentConfigSection },
    { id: "agents", label: "智能体", icon: UserMultiple02Icon, component: AgentsSection },
